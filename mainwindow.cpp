    ...
    m_networkMonitor(new NetworkMonitor(this))
{
    ...
    m_dashboardManager->installEventFilter(this);
...
{
    NetworkInfoModel* viewModel = new NetworkInfoModel(info, this);
...
void MainWindow::initializeNetworkDashboardManager()
{
    ...
    void MainWindow::addOrUpdateNetworkWidget(const QNetworkInterface &interface)
    {
        ...
        if(!m_widgets.contains(mac))
        {
            ...
            NetworkInfoModel* viewModel = new NetworkInfoModel(netInfo, this);
